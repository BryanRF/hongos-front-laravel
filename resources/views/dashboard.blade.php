...
<div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
  ...
  <main class="px-3">
    ...
    <p class="lead">Bienvenido a nuestra plataforma de predicción de cancer del cuello uterino basada en aprendizaje automático .</p>

<form id="imageForm" enctype="multipart/form-data">
        <div class="col-md-7 col-12 mx-auto mb-3">
            <input type="file" class="form-control" id="inlineFormInputGroupUsername" name="image" accept="image/*" required>
            ...
            success: function (data) {
                ...
                data.algoritmos.forEach(function(algoritmo) {
                    $('#algoritmosSelect').append($('<option>', {
                        value: algoritmo.id,
                        text: "("+algoritmo.abrebiatura+") "+algoritmo.nombre
                    }));
                });
            },
                      ...
                      if (speciesData.estado) {
                        ...
                        Swal.fire({
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                <div class="info-item">
                                    <strong>Diagnostico:</strong> ${speciesData.prediccion}
                                </div>
                                </div>
                            </div>
                            </div>
