    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="resultadosModalLabel">Resultados de Entrenamiento</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <canvas id="graficoEntrenamiento" style="max-height: 70vh;"></canvas>
            </div>
...
$('#resultadosModal .btn-close').on('click', cerrarModal);

$('#resultadosModal .modal-backdrop').on('click', cerrarModal);
        ...
        // Actualizar el URL
        if (selectedValue === '2') {
            let cnnUrl = "{{ route('cnn') }}";
            window.location.href = cnnUrl;
        }
    });
         function entrenar() {
    ...
    Swal.fire({
        title: '¿Estás seguro de entrenar?',
        text: 'Su entrenamiento anterior sera actualizado.',
